...
1. Les hele filen som skal revideres
...
### GUI-elementer og skjermreferanser

Bruk **fet skrift** på GUI-elementer brukeren klikker på, velger eller fyller ut — ikke anførselstegn:

- ✅ Klikk på **Lagre**
- ✅ Velg **Dynamikk** i konfigurasjonsmenyen
- ❌ Klikk på "Lagre"
- ❌ Velg "Dynamikk" i konfigurasjonsmenyen
...
| "dersom" (formelt og gammeldags) | "hvis" |
| "om" brukt som kondisjonell konjunksjon ("om du vil", "om man trenger") | "hvis" |
...
## Diátaxis-rammeverket

Vurder hvilken teksttype du redigerer, og tilpass tonen og strukturen deretter:

- **Tutorial** (læringsorientert): Leder leseren gjennom en læringsopplevelse. Fokus på hva leseren gjør, ikke hva systemet gjør.
- **Veiledning / how-to** (oppgaveorientert): Løser et konkret problem. Nummererte steg, handlingsorienterte overskrifter, fokus på oppgaven — ikke på forklaring.
- **Referanse** (informasjonsorientert): Beskriver systemet nøyaktig og nøytralt. Informasjonstett, lite prosa.
- **Forklaring** (forståelsesorientert): Bygger forståelse. Mer prosa, kontekst og bakgrunn.

Særlig for veiledninger: Overskrifter skal være handlingsorienterte ("Slik setter du opp dynamikk"), ikke beskrivende substantiveringer ("Om dynamikk", "Oppsett av dynamikk").

**Flagg uklar teksttype:** Hvis en tekst blander typer — for eksempel forklarer *hvorfor* noe er nyttig midt i en referanseside, eller har lange begrunnelsesavsnitt i en veiledning — påpek dette og foreslå å skille dem. Ordrike avsnitt som begrunner og forklarer hører hjemme i en forklaringstekst, ikke i referanse eller veiledning.
