...
**LØSNING PÅ MYSTERIET FRA 15. JAN 2026:**
Bildene fungerte for `_index.nb.md` (access-management) men ikke for `lage-datamodell.nb.md` og `vedlegg.nb.md` - fordi sistnevnte ikke var page bundles!
...
## Status 7. januar 2026
- **Dagens arbeid**: Lagt til innhold i "Utforme en god tjeneste"
- **Fil**: `/content/altinn-studio/v10/plan-a-service/tips-and-advice/design/_index.nb.md`
- **Hva som ble gjort**:
  - Strukturert innhold i 5 hovedseksjoner med kulepunkter
  - Lagt til infopaneler for kommende innhold (bilder og lenker)
  - Lagt til lenker til eksisterende artikler (Lag gode spørsmål, Brukertesting)
  - Fjernet `add-content` tag fra frontmatter
