 ...
 <div class="row adocs-featuredBlocks">
        ...
        <div style="text-align: center;">
            ...
            <div class="a-illustration-icon">
                ...
                <div class="a-illustration-overlay">
                    <span class="sr-only">Om Altinn Autentisering</span>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-lg-6 mb-5">
        ...
        <div class="a-list-container mb-2 mx-auto mx-lg-6">
            <ul class="a-list a-list-noIcon">
                <li class="a-dotted a-clickable a-list-hasRowLink">
                    <a href="getting-started/systembruker/" class="a-list-rowLink">
                        <div class="row">
                            <div class="col">
                                Systembruker
                            </div>
                ...
                <li class="a-dotted a-clickable a-list-hasRowLink">
                    <a href="getting-started/maskinportenclient/" class="a-list-rowLink">
                        <div class="row">
                            <div class="col">
                                Maskinportenklient
                            </div>
