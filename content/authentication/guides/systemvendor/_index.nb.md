...
1. Logg inn på [onboarding Maskinporten](https://onboarding.test.maskinporten.no/). Her kan du bruke en testidentitet som er daglig leder i en testvirksomhet.
      ...
      ![Onboarding](assets/onboarding1.png "Forenklet onboarding")

      ![Onboarding](assets/onboarding2.png "Velg virksomhet")

      ![Onboarding](assets/onboarding3.png "Oversikt over integrasjoner i Maskinporten. Her kan du legge til nye")

      ![Onboarding](assets/onboarding4.png "Opprett integrasjon, søk etter nødvendig scope")

      ![Onboarding](assets/onboarding5.png "Legg til eventuelle ekstra scope og beskriv integrasjonen")

      ![Onboarding](assets/onboarding6.png "Last ned genererte nøkler")

      ![Onboarding](assets/onboarding7.png "Integrasjon opprettet")
...
3. Logg inn med en testbruker på tt02.altinn.no. Brukeren må ha tilgangsstyringsrollen i Altinn for en testorganisasjon og gå til siden [https://authn.ui.tt02.altinn.no/authfront/ui/auth/creation](https://authn.ui.tt02.altinn.no/authfront/ui/auth/creation).
      ![Onboarding](assets/delegering1.png "Velg et system")

      ![Onboarding](assets/delegering2.png "Godkjenn opprettelse av systembruker med spesifisert rettighet")

      ![Onboarding](assets/delegering3.png "Systembruker oversikt for test organisasjon")
