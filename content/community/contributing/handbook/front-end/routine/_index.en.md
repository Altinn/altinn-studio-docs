...
2. Code your changes and test them by [running an app locally](/en/community/contributing/handbook/front-end/developing#app-frontend).
3. Run unit tests
   - Update any failing tests
   - Add new tests when needed
4. Make sure you update the `version` in `altinn-app-frontend/package.json`, following [semantic versioning](/en/community/contributing/handbook/front-end/versioning/). 
...
10. Update any relevant documentation. F.ex.
    - [Changelog for app frontend](/en/community/changelog/app-frontend/).
    - [User documentation](/en/altinn-studio).
...
2. Code your changes and test them by [running Designer locally](/en/community/contributing/handbook/front-end/developing#altinn-studio-designer).
3. Run unit tests
   - Update any failing tests
   - Add new tests when needed
