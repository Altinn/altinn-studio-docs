...
### App frontend
Details of the architecture for app frontend can be found [here](/technology/architecture/components/application/construction/altinn-apps/app/app-frontend).
