...
{{%excerpt%}}
<object data="/nb/app-template/architecture/app-frontend/frontend-react-architecture.svg" type="image/svg+xml" style="width: 100%; max-width: 1000px"></object>
{{% /excerpt%}}
...
Details of the architecture for app frontend can be found [here](/nb/app-template/architecture/app-frontend/).

### Altinn Studio Designer frontend

Details of the Altinn Studio Designer can be found [here](/nb/altinn-studio/v8/designer/)
