...
Added possibility to setup options from repeating groups in the data model. Read more on [docs.]({{< relref "/altinn-studio/v8/guides/development/options/sources/from-data-model" >}})
