...
in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#support-for-auto-delete-when-process-ends)**
...
**Updating to this version will require changes in multiple files. See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#designer-moves-formlayoutjson-from-appui-to-appuilayouts)**
...
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#added-registration-of-events-to-the-new-events-component)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#support-for-deleting-instances-from-endpoint-in-app)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#update-path-of-data-protection-keys-for-apps)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#build-pipeline-failed-on-task-build-and-push-docker-image-to-acr)**
...
**Updating to this version will require changes in multiple files.
See the entries in breaking changes [here](/en/community/changelog/app-nuget/older/breaking-changes/#property-type-changed-for-userprofileprofilesettingpreference)
and [here](/en/community/changelog/app-nuget/older/breaking-changes/#new-endpoint-introduced-in-altinnappsapi-exposing-application-text-resources)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#platform-authorization-introduced-for-platform-register-and-profile)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#updated-client-side-validation---frontend-v2-and-nuget-v1082-alpha)**
...
**Updating to this version will require changes in multiple files.
See the entry in [breaking changes](/en/community/changelog/app-nuget/older/breaking-changes/#build-fails-after-upgrading-altinnapp-nugets-to-version-1062-alpha)**
