...
Ny måte å implementere dynamiske kodelister ved hjelp av IAppOptionsProvider. [Se dokumentasjon](/nb/altinn-studio/v8/guides/development/options/)
...
[Les mer om dette her](/nb/altinn-studio/v8/reference/configuration/queryparameters/)   
...
[Det nye endepunktet er dokumentert her](/nb/api/apps/instances/). 
...
[documentation on how to implement the functionality](/nb/altinn-studio/v8/reference/logic/validation/#spesifisere-at-valideringsfeil-er-fikset) (in Norwegian )
...
See details about data processing [here](/nb/altinn-studio/v8/reference/logic/dataprocessing/)

## 4.6.2 (2021-06-01) - Duplicate keys in options causing crash

This release has a fix for a crash related to PDF rendering when an app has [options](/nb/altinn-studio/v8/guides/development/options/) with duplicate entries. [#5887](https://github.com/Altinn/altinn-studio/issues/5887)
...
Documentation on how to add data values to an instance can be found [here](/nb/altinn-studio/v8/reference/configuration/datafields/).
...
Further documentation on how to configure presentation fields is found [here](/nb/altinn-studio/v8/reference/configuration/messagebox/presentationfields/).
...
See [breaking changes](/nb/community/changelog/app-nuget/v4/breaking-changes/) for how to update you app to be compatible with this version.
