...
[documentation on how to implement the functionality]({{< relref "/altinn-studio/v8/reference/logic/validation/#spesifisere-at-valideringsfeil-er-fikset" >}}) (in Norwegian )
...
Further documentation on how to configure presentation fields is found [here]({{< relref "/altinn-studio/v8/reference/configuration/messagebox/presentationfields/" >}}).
