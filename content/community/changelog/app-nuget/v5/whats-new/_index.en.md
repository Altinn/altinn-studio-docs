...
### Features
- This release introduces new api endpoints which gives information about the languages supported in the application. Ref. upcoming feature for [selecting language]({{< relref "/altinn-studio/v8/reference/ux/texts/translation/" >}})
