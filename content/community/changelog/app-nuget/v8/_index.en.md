...
To see how you can use custom process actions, see [defining custom actions in process tasks]({{< relref "/altinn-studio/v8/reference/process/actions/process-actions" >}}).
...
To see how you can use custom server actions, see [defining custom actions in process tasks]({{< relref "/altinn-studio/v8/reference/process/actions/serveraction/" >}}).