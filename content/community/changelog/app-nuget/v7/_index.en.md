...
## What's changed?
Read the following to get a high level overview over what's changed', then move on to the [breaking changes](/en/community/changelog/app-nuget/v7/breaking-changes/) page for instructions on how to upgrade.
