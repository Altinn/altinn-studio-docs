...
- Archiving of Correspondences is not currently supported in the Altinn 3 implementation
  ...
  - Migrated correspondences from Altinn 2 that become archived will get the "archive" system label set. In addition the correspondence will have logged the unique "Archived" status i StatusHistory; not used by Altinn 3 Correspondences.
