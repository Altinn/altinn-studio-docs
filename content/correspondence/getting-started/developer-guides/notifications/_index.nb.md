...
|------|----------------|-------------|
| `emailSubject` | 512 tegn | Øvre grensen for e-postemner i varslinger. Altinn Notifications-tjenesten anbefaler å holde epost emnet kortere enn 128 tegn for å sikre at emnet vises korrekt i e-postklienter |
