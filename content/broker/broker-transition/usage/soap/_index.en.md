...
If possible, you should consider adding steps that make calls to [Get File Receipt](/en/broker/broker-transition/usage/rest/#get-file-receipt-outbox-sender) to ensure that the file has been successfully processed.
