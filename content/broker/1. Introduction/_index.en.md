...
| Cloud                          | TBD                                                                                                                                                                                                                                                      |
| Consumer                       | TBD                                                                                                                                                                                                                                                      |
| Data Broker                    | Erik: Fix beskribesøe!!! Ref. <https://www.gartner.com/en/information-technology/glossary/data-broker>: A Data Broker is a business that aggregates information from a variety of sources; processes it to enrich, cleanse or analyze it; and licenses it to other organizations. |
| Dialog                         | TBD                                                                                                                                                                                                                                                      |
| Document                       | TBD                                                                                                                                                                                                                                                      |
