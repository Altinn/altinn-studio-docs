...
Et særegent trekk ved Altinn Formidling er evnen til å håndtere store datamengder (payloads). Systemet støtter filoverføring på opptil hele 1600 GB uten virusskanning (inntil 50 GB med virusskanning). Dette er løsningen for deg som trenger å overføre store mengder informasjon effektivt og sikkert. 
