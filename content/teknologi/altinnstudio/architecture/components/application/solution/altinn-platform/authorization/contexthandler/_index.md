...
See [construction components for context handler](/teknologi/altinnstudio/architecture/components/application/construction/altinn-platform/authorization/#context-handler) for implementation details for the context handler.
