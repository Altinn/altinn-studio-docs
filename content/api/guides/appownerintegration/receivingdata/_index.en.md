...
5. The application publishes an event that the end user has completed the filling process. (Assumes that publishing is [enabled]({{< relref "/altinn-studio/v8/getting-started/app-dev-course/modul5/" >}}))
