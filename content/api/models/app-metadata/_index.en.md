...
| allowedContributers              | A list of allowed contributors. This can be used to restrict editing of the datatype so that only service owner or system user tokens can edit. Use the format '{keyword}:{value}'. Approved keywords are: _org_ and _orgno_. Value should be corresponding three letter org name or orgnumber. Example: `"orgno:123456789"`. |
