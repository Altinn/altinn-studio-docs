...
```json
{
    ...
    "workflowStepId": "Step12345",
    "enduserSystemId": 123456
}
```
...
```http
/instanceevents/GetByInstanceEventType?instanceId={instanceId}&eventTypes={eventTypeA}&eventTypes={eventTypeB}
```

Get all instance events for a specific instance within a time frame
The times are strings defined in UTC-format. E.g. 2019-05-02T13:08:21.981476Z
```http
/instanceevents/GetByTimeFrame?instanceId={instanceId}&from={fromtime}&to={totime}
```
