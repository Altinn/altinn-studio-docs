...
As part of the Application design and build in Altinn Studio the application developer will [define a BPMN Process](/en/technology/architecture/capabilities/runtime/appdevelopment/) for the given App. 
