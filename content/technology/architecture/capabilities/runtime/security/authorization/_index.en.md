...
These components are described in detail under [solution components](/en/authorization/)
...
See details in [Policy Administration Point in Altinn Studio](/en/altinn-studio/v8/designer/build-app/authorization-rules/).
...
The below show the future of Authorization Component. [Work in progress](/en/authorization/)

![The future](/en/authorization/what-do-you-get/authorization_solution_components_future.drawio.svg)
