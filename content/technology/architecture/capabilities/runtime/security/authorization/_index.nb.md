...
These components are described in detail under [solution components](/nb/authorization/)
...
See details in [Policy Administration Point in Altinn Studio](/nb/altinn-studio/v8/designer/build-app/authorization-rules/).
...
The below show the future of Authorization Component. [Work in progress](/nb/authorization/)

![The future](/nb/authorization/what-do-you-get/authorization_solution_components_future.drawio.svg)
