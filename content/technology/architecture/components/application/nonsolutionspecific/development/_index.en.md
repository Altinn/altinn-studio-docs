...
#### Unit Test
- [Jest](https://jestjs.io/) framework used for unit testing front-end. More details [here]({{< relref "/community/contributing/handbook/test/unit-testing/" >}}).
- [xunit](https://xunit.net/) used for unit testing back-end.

#### Service & API Test

- API testing is done using Postman. More details [here]({{< relref "/community/contributing/handbook/test/postman/" >}}).
...
[See our Figma Guidlines]({{< relref "/altinn-studio/v8/guides/design/prototype" >}}).
