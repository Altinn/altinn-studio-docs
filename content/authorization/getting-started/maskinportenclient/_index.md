...
Maskinporten clients are managed in [Samarbeidsportalen](https://sjolvbetjening.samarbeid.digdir.no) [test environment](https://sjolvbetjening.test.samarbeid.digdir.no)

![Maskinporten](maskinporten1.png "Setting up client")

## Selecting scopes

Depending on usage you would need to select the correct scopes
...
If you use Azure Key Vault to store your private keys this need to be base 64 encoded before adding it to the secrets
