...
description: Applikasjonsarkitekturen og hoved-API-flatene i Altinn Access Management.
weight: 5
toc: true
---

Access Management har egne API-flater for sluttbrukere, virksomheter, Maskinporten, metadata, tjenesteeiere og interne konsumenter. Skissen viser de viktigste API-kontrollerne innenfor hver flate.
