...
See [construction components for context handler]({{< relref "/authorization/reference/architecture/accesscontrol/#context-handler" >}}) for implementation details for the context handler.
