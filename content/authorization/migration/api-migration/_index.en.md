...
Disse APIene vil som en hovedregel kun ha tilgang til informasjon fra Altinn 2 plattformen. Etterhvert som tjenesteeier flytter sine [ulike tjenester](/en/authorization/migration/servicemigrationplan/) ut fra Altinn 2, så vil det være begrenset om man
...
[Her finner du migreringsplaner for sluttbrukersystem-API](/en/authorization/migration/api-migration/sbs-api/).
...
[Her finner du migreringsplaner for tjenesteeeier-API](/en/authorization/migration/api-migration/te-api/).
