...
Beskrivelse av de nye APIene for tjenesteeiere finnes i [swagger](https://docs.altinn.studio/nb/api/authorization/spec/#/Decision/post_authorize). Denne er fortsatt under arbeid.
