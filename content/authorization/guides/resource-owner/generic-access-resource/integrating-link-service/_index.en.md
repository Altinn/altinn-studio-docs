...
The setup of the Maskinporten client and the exchange process are described [here](/en/authorization/getting-started/authentication/).
...
Input is social security number to authenticated person in the following format
