...
To change delegation information for apps from Altinn 1 and Altinn 2, these can be imported to Altinn Studio resource administration. For these services to work as normal, it is important to change access from Altinn 2-roles to access packages. These services are displayed in the list on the resource dashboard and will have a resource ID starting with app\_{serviceownercode}\_a1 or app\_{serviceownercode}\_a2. To import these, click the import button to the right on the list item. They can then be published as normal resources.
