...
Det er tilknyttet virksomhet og personer reigstrert med nøkkelroller i denne som får fullmakter på vegne av den aktuelle virksomheten. I tabeller på [denne siden]({{< relref "/authorization/what-do-you-get/accessgroups/register_er/" >}}) finner du oversikt over hvilke nøkkelroller som finnes på ulike organisasjonsformer. 
