...
An access package groups services and resources that are commonly used together, for example for payroll, accounting or agriculture. This makes it easier for an organisation to grant a person or system the access needed for a task.

Service owners decide which access package their services belong to. Digdir provides the technical structure, whilst the participating service owners determine the content.
