...
**Read more**
* [Handling front channel embeds in dialog details]({{< relref "/dialogporten/user-guides/getting-dialog-details" >}}#handling-front-channel-embeds)
