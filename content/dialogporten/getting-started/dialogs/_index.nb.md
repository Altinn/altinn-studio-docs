...
For trinnvise veiledninger om hvordan du bruker Dialogporten som sluttbruker eller tjenesteeier, se [brukerhåndbøkene](../../user-guides).
...
I tillegg kan en dialog inneholde en innholdsreferanse kalt en [front channel embed](../front-channel-embeds), som er en URL til et spesielt endepunkt levert av tjenesteeieren som returnerer en "full" personlig tilpasset nyttelast.
...
En forsendelse inneholder noen tekstlige metadata (tittel, sammendrag) som forklarer hva forsendelsen er, inkludert [front channel embed](../front-channel-embeds). I tillegg kan en forsendelse inneholde ett eller flere [vedlegg](#vedlegg).
...
{{<notice warning>}}
Brukerdefinert etikettfunksjonalitet er under design, og vil bli gjort tilgjengelig på et senere tidspunkt. Se [nyheter](../../news) -seksjonen for oppdatert informasjon.
{{</notice>}}
