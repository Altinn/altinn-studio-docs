...
For trinnvise veiledninger om hvordan du bruker Dialogporten som sluttbruker eller tjenesteeier, se [brukerhåndbøkene]({{<relref "../../user-guides">}}).
...
I tillegg kan en dialog inneholde en innholdsreferanse kalt en [front channel embed]({{<relref "../front-channel-embeds">}}), som er en URL til et spesielt endepunkt levert av tjenesteeieren som returnerer en "full" personlig tilpasset nyttelast.
...
GUI-handlinger kan imidlertid merkes som [skrivehandlinger]({{<relref "../write-actions">}}) og kan da også brukes til å gjøre tilstands-endringer.
