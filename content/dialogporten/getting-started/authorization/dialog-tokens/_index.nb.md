...
{{<notice warning>}}
Et front channel embed på forsendelsesnivå er unntaket: hvis forsendelsen har en [autorisasjonskontekst]({{< relref "../authorization-contexts/" >}}), bruk forsendelsens konteksttoken i stedet for dialogtokenet.
{{</notice>}}
...
Dialogporten utsteder en ny, snevrere token-type for entiteter med en [autorisasjonskontekst]({{< relref "../authorization-contexts/" >}}), signert med de samme nøklene som dialogtokenet, men skilt fra det med JOSE-headeren `typ`. Se [konteksttoken]({{< relref "../../../reference/authorization/context-tokens/" >}}) for detaljer.
