...
The dialog token also enables [front channel embeds](/en/dialogporten/getting-started/authorization/dialog-tokens/../../front-channel-embeds/) and [write actions](/en/dialogporten/getting-started/authorization/dialog-tokens/../../write-actions/), which are point-to-point interactions between the end user's device or system and the service provider systems, avoiding the need for intermediaries to handle data transfers.
