...
Hver autorisasjonskontekst setter en `unauthorizedPresentation`, enten `Disabled` eller `Redacted`, som avgjør hva en uautorisert sluttbruker ser for den delen av dialogen. Uansett valg fjernes aldri selve entiteten fra svaret - Dialogporten dropper ikke stille entiteter den nåværende brukeren ikke har tilgang til, så posisjoner og antall i listene holder seg stabile uansett hvem som spør.

Med `Disabled` forblir entiteten synlig med innholdet intakt, men eventuelle URL-er erstattes med en plassholder. Med `Redacted` blir entiteten i tillegg fratatt innholdet sitt, slik at det bare gjenstår nok til å vise at det finnes noe i den posisjonen, uten å avsløre hva det er.
