...
For additional control, the [app template]({{<relref "../../../app-template">}}) utilizes a [Dialogporten API client]({{<relref "../user-guides/service-owners/api-client">}}) that enables the app to take full control on how the app is represented in Dialogporten, and thus portals like Altinn Inbox ("arbeidsflate").
