...
`contextToken` er til stede hvis, og bare hvis, entiteten har en autorisasjonskontekst *og* den nåværende brukeren er autorisert for den. Ellers er den `null` - blant annet alltid når `isAuthorized` er `false`.
