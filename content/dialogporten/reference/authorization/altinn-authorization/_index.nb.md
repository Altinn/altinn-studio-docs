...
Alle listevisninger i Dialogporten benytter [Authorized Parties API]({{<relref "../../../../authorization/guides/resource-owner/integrating-link-service/#integrasjon-med-api-for-autoriserte-parter-avgivere">}}), som gir en liste over alle parter den autentiserte brukeren kan representere sammen med alle roller/tilgangspakker og tjeneste-/instansrettigheter som brukeren har fått for hver part.
...
For dialogdetaljer benyttes [PDP API]({{<relref "../../../../authorization/guides/resource-owner/integrating-link-service/#integrasjon-med-pdp">}}), som gir mulighet for finkornet autorisering av de forskjellige handlingene og overføringene som er definert i dialogen.
