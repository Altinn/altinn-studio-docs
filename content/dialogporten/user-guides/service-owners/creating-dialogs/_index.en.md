...
{{<notice info>}}
For information on how to use HTTP-based concurrency control via `ETag` / `If-Match`-headers, see the guide for [updating dialogs]({{< relref "/dialogporten/user-guides/service-owners/creating-dialogs/../updating-dialogs//" >}}).
{{</notice>}}
