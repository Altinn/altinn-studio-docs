...
Denne veiledningen viser hvordan du bruker Dialogportens proxy-API mot Altinn Access Management for å hente listen over [autoriserte parter](/nb/dialogporten/getting-started/authorization/parties#autoriserte-parter) som den autentiserte brukeren har tilgang til.
...
* Identifikatoren for parten, som kan brukes når du [søker etter dialoger](/nb/dialogporten/user-guides/searching-for-dialogs/)
...
Feltet `party` i svaret er parti-URN-en du bruker i [dialogsøk](/nb/dialogporten/user-guides/searching-for-dialogs/). De øvrige feltene beskriver parten og forholdet den autentiserte brukeren har til den, inkludert om parten er den nåværende sluttbrukeren og om brukeren har viktige administrative roller.
