...
4. Utfør forespørsler til [tjenesteeier-API](/nb/dialogporten/reference/openapi/) ved hjelp av tilgangstokenet i en `Authorization: Bearer <token>`-header.
