...
![Eksempel på komponentbibliotek](Figma-movie-1.gif "Figma, eksempel på komponentbibliotek")
...
![Eksempel på endring av masterkomponent](Figma-movie-2.gif "Figma, eksempel på endring av masterkomponent")
...
![Eksempel på bruk av grid og innhenting av komponenter](Figma-movie-3.gif "Figma, eksempel på bruk av grid og innhenting av komponenter")
...
![Eksempel på varianter av en komponent](Figma-movie-4.gif "Figma, eksempel på varianter av en komponent")
...
![Eksempel på versjonshistorikk](Figma-movie-6.gif "Figma, eksempel på versjonshistorikk")
...
![Eksempel på lenking mellom sidemaler](Figma-movie-7.gif "Figma, eksempel på lenking mellom sidemaler")

## Eksempel på Altinns Figma-filer

De navigerbare rammene under viser eksempler på filer vi har i komponentbiblioteket vårt.
For å få tilgang til biblioteket, ta kontakt med [Alise Kjelling](mailto:alise.kjelling@digdir.no).
