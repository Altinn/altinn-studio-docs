...
{{% notice info %}}
If you want to test the app in a [test environment](/app/guides/testing/deploy/) (described in [Module 3](/app/app-dev-course/module3/)), you need to select an organization as the owner.
You must have [access to the organization](/app/getting-started/create-user/#joining-an-organization), and the organization must have access to a test environment.
{{% /notice %}}
