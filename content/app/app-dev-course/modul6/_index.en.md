...
- [Configuration of field grouping](/app/development/ux/fields/grouping)
- [Configuration of repeating groups](/app/development/ux/fields/grouping/repeating)
...
1. Create a file for [data processing](/app/development/logic/dataprocessing/).
...
* **Add a validation trigger to the address component:**
...
* **Create a class that implements `IDataProcessor` as described in [data processing](/app/development/logic/dataprocessing/) and add data processing logic:**
