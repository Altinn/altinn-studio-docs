...
2. [Last opp datamodellen i Altinn Studio](/nb/app/development/data/data-model/)
...
### Nyttig dokumentasjon
- [Laste opp datamodell i Altinn Studio](/nb/app/development/data/data-model/)
...
- [Hvordan synkronisere endringer i lokalt utviklingsmiljø](../../getting-started/local-dev/#hvordan-synkronisere-endringer-i-lokalt-utviklingsmiljø)
{{% /expandlarge %}}
