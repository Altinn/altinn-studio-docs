...
To enrich the form data we need to include the use of our client in the logic of the method _ProcessDataWrite_ in _App/logic/DataProcessingHandler.cs_.
