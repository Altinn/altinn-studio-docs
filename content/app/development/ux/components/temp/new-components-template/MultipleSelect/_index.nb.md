...
linktitle: MultipleSelect
description: # Kort beskrivelse av komponenten
schemaname: MultipleSelect # Komponentens schema-navn, brukes for å automatisk generere liste med egenskaper fra komponentens JSON schema (erstatt med riktig navn i henhold til schema)
