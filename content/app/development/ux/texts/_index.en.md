...
the user tries to continiue to the next page even though it is required to add one attachments. This default error message 
...
![Tekster i appen](defaultTextsEN.png "Default texts and id:s")
