...
1. Du vil finne eksempler på hvordan du tilpasser filen `process.bpmn`, der applikasjonsprosessen er definert, i
   [prosessdokumentasjonen](/app/development/configuration/process).
...
Les om hvordan denne egendefinerte koden legges til [her](/app/development/configuration/process/pre-post-hooks).
...
- **Alt 2:** Hvis intensjonen er å manipulere tekstene i Altinn
  ...
  bruk [_presentasjonsfelt_](/app/development/configuration/messagebox/presentationfields)
  .
