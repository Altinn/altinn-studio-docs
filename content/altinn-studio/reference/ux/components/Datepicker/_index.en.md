...
| `gridSettings.innerGrid`               | gridProps | Optional grid for inner component content like input field or dropdown. Used to avoid inner content filling the component width. **Example(s):** `{xs: 12}` See: [gridProps](/altinn-studio/reference/ux/components/commondefs#gridProps)                                 |
| `gridSettings.labelGrid`               | gridProps | Optional grid for the component label. Used in combination with innerGrid to align labels on the side. **Example(s):** `{xs: 12}` See: [gridProps](/altinn-studio/reference/ux/components/commondefs#gridProps)                                                           |
