...
| `gridSettings.innerGrid`               | gridProps | Valgfri. Rammer for indre komponentkontekst, så som input felt dropdown. Brukes for å unngå at feltet fyller komponentens fulle bredde. **Eksempel:** `{xs: 12}` Se: [gridProps](/altinn-studio/reference/ux/components/commondefs#gridProps)                                                   |
| `gridSettings.labelGrid`               | gridProps | Valgfri. Rammer for komponentens tittel. Brukes i kombinasjon med innerGrid for å likestille bredden på titler på siden. **Eksempel:** `{xs: 12}` Se: [gridProps](/altinn-studio/reference/ux/components/commondefs#gridProps)                                                                  |
