...
Fra versjon `7.2.0` av [nuget-pakkene](../../../guides/administration/maintenance/dependencies#nuget) er også uttrykkene støttet i backend.
...
linje i `App/appsettings.json` etter at man har oppgradert [nuget-pakkene](../../../guides/administration/maintenance/dependencies#nuget)
