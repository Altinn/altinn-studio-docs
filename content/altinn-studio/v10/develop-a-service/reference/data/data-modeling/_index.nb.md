...
Du finner lenken til dette repoet i [Altinn Studio Dashboard]({{< relref "/altinn-studio/v8/getting-started/navigation/dashboard" >}}). Velg **Rediger** (blått blyant-ikon) for å komme til Altinn Studio-verktøyet for datamodellering. Velg **Gitea** (grønt kopp-ikon) for å se filene direkte i repoet.
...
1. Logg inn i Altinn Studio. Hvis du ikke er i [Altinn Studio Dashboard]({{< relref "/altinn-studio/v8/getting-started/navigation/dashboard" >}}), klikk på logoen øverst i venstre hjørne eller gå til [altinn.studio/dashboard](https://altinn.studio/dashboard).
