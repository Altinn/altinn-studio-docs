...
For å endre prosessen kan du manuelt redigere BPMN-filen med en valgfri XML- eller BPMN-editor. Den ligger lagret i app-lageret som `App/config/process/process.bpmn`.
