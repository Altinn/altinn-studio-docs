...
|----------|-------------|----------------|
| `type` | Required. | `"CustomButton"` |
| `actions` | Required. |  |
| `buttonStyle` | The style/color scheme of the button. | `"primary"`, `"secondary"`, `"tertiary"` |
| `buttonColor` | The color scheme of the button. | `"first"`, `"second"`, `"success"`, `"danger"` |
| `buttonSize` | The size of the button. | `"sm"`, `"md"`, `"lg"`, `"small"`, `"medium"`, `"large"` |
...
| Property | Description | Allowed Values |
|----------|-------------|----------------|
| `title` | The title/text on the button |  |
| `tableTitle` | The title/text for the button when rendered in a table |  |
