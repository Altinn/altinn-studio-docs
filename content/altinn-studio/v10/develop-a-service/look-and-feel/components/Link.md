...
| `style` | The style of the link (a primary/secondary button, or an actual link) Required. | `"primary"`, `"secondary"`, `"link"` |
...
| `download` | Download target instead of navigating to it. Non-blank value is passed to the download attribute and becomes the filename of the downloaded file. Blank value means default filename is used. |  |
