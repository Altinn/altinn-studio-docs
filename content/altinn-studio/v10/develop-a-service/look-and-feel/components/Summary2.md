...
|----------|-------------|----------------|
| `type` | Required. | `"Summary2"` |
| `target` | See [Target](#target-target). |  |
| `showPageInAccordion` |  |  |
| `isCompact` |  |  |
| `hideEmptyFields` | Set this to true if you don't want to show fields that have not been filled out. |  |
| `overrides` |  |  |
...
| `type` | Required. | `"page"` |
| `id` | Required. |  |
| `taskId` | Use this if you want to render a page from another task. |  |
