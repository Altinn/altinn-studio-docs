...
|----------|-------------|----------------|
| `src` | Required. |  |
| `src.nb` | Audio source (when using norwegian bokmål language) |  |
| `src.nn` | Audio source (when using norwegian nynorsk language) |  |
| `src.en` | Audio source (when using english language) |  |
