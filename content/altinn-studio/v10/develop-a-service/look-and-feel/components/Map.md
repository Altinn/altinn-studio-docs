...
| `geometries` |  |  |
| `geometries.dataType` | The name of the datamodel type to reference Required. |  |
| `geometries.field` | The path to the property using dot-notation Required. |  |
| `geometryLabel` |  |  |
| `geometryLabel.dataType` | The name of the datamodel type to reference Required. |  |
| `geometryLabel.field` | The path to the property using dot-notation Required. |  |
| `geometryData` |  |  |
