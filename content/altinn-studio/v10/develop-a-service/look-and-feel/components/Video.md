...
|----------|-------------|----------------|
| `src` | Required. |  |
| `src.nb` | Video source (when using norwegian bokmål language) |  |
| `src.nn` | Video source (when using norwegian nynorsk language) |  |
| `src.en` | Video source (when using english language) |  |
