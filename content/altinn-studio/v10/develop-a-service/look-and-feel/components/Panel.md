...
| `variant` | Change the look of the panel | `"info"`, `"warning"`, `"error"`, `"success"` |
| `showIcon` | Show icon in the panel header |  |

## Text resource bindings (`textResourceBindings`)

| Property | Description | Allowed Values |
|----------|-------------|----------------|
| `title` | Header/title of the panel |  |
| `body` | Body of the panel |  |
