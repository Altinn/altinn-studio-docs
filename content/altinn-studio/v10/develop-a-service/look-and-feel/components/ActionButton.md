...
|----------|-------------|----------------|
| `type` | Required. | `"ActionButton"` |
| `textResourceBindings` | See [Text resource bindings](#text-resource-bindings-textresourcebindings). |  |
| `action` | The action to perform when the button is clicked. Required. | `"instantiate"`, `"confirm"`, `"sign"`, `"reject"` |
| `buttonStyle` | The style/color scheme of the button. Required. | `"primary"`, `"secondary"` |
