...
| `mode` | The mode of the button | `"submit"`, `"save"`, `"instantiate"` |
| `mapping` | A mapping of key-value pairs (usually used for mapping a path in the data model to a query string parameter). |  |
