...
| `groupingIndicator` | Can visually group components together by indenting them or by putting them in a panel.  | `"indented"`, `"panel"` |
| `children` | Array of component IDs that should be displayed in the group Required. |  |
| `headingLevel` | The heading level of the group title. | `2`, `3`, `4`, `5`, `6` |
...
| `title` | The title of the group (shown above the group) |  |
