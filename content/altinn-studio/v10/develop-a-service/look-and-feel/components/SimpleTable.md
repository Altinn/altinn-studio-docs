...
| `columns[].accessors` | List of fields that should be included in the cell Required. |  |
| `columns[].component` |  |  |
| `columns[].component.type` | Required. | `"link"` |
| `columns[].component.hrefPath` | Required. |  |
| `columns[].component.textPath` | Required. |  |
| `columns[].component.openInNewTab` |  |  |
| `columns[].component.format` | Date format used when displaying the date to the user |  |
| `columns[].component.options` |  |  |
| `columns[].component.options[].label` | Required. |  |
| `columns[].component.options[].value` | Required. |  |
| `zebra` | If true, the table will have zebra striping |  |
| `enableDelete` | If true, will allow user to delete row |  |
| `enableEdit` | If true, will allow user to edit row |  |
| `size` | Size of table. | `"sm"`, `"md"`, `"lg"` |
| `externalApi` | See [External api](#external-api-externalapi). |  |
...
|----------|-------------|----------------|
| `tableData` | Required. |  |
| `tableData.dataType` | The name of the datamodel type to reference Required. |  |
| `tableData.field` | The path to the property using dot-notation Required. |  |
