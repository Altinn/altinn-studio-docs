...
| `type` | Required. | `"AccordionGroup"` |
| `textResourceBindings` | See [Text resource bindings](#text-resource-bindings-textresourcebindings). |  |
| `children` | List of child component IDs to show inside the accordion group (limited to other Accordion components) Required. |  |
...
| `title` | The title of the accordion group |  |
