...
Du definerer regler ved hjelp av [dynamiske uttrykk]({{< relref "/altinn-studio/v10/develop-a-service/look-and-feel/dynamics" >}}).
...
- **severity** – Typen valideringsfeil: `error`, `warning`, `info` eller `success`. Hvis feltet utelates, brukes `error`. Se [myke valideringer]({{< relref "/altinn-studio/v10/develop-a-service/data/validation/" >}}).
- **condition** – Et dynamisk uttrykk som returnerer `true` hvis feilen skal vises, og `false` ellers. Se [dynamiske uttrykk]().
