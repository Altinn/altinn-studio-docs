...
3. [Lagre autentiseringsnøkkelen for integrasjonen i Azure Key Vault](#konfigurere-azure-key-vault).
...
[Azure Key Vault-konfigurasjon](#konfigurere-azure-key-vault).
