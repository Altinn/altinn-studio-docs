...
4. Du kan overstyre teksten som vises når listen er tom, før noen har signert, ved å legge til en tekst for tekstressursnøkkelen `signee_list.no_signees` i tekstressursfilene.
