...
If [runtime-delegated signing](/en/altinn-studio/v10/develop-a-service/process/signing/runtime-delegated-signing/) is configured, the following endpoint can be used to get a list of the signees and their signing status.
