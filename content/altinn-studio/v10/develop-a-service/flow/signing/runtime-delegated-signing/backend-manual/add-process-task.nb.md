...
{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/add-process-task-environments.nb.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/add-process-task-code-01.en.md" %}}

Denne datatypen benyttes for å lagre informasjon om signatarene og statusen deres.

{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/add-process-task-code-02.en.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/add-process-task-code-03.en.md" %}}
