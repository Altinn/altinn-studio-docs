...
{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/setup-text-resources-code-01.en.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/flow/signing/runtime-delegated-signing/backend-manual/setup-text-resources-code-02.en.md" %}}
