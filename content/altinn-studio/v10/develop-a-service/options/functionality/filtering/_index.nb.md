...
- De allerede brukte ingredienstypene lagres i en kommaseparert liste i feltet `UsedTypes` i datamodellen. Dette feltet oppdateres via [dataprosessering]({{< relref "../../../../reference/logic/dataprocessing" >}}) som finner alle unike ingredienstyper i `Ingredients`-lista.
