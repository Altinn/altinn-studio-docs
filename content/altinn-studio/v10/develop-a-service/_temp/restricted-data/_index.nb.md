...
[her](/nb/altinn-studio/v10/develop-a-service/_temp/reference/integration/maskinporten/).
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/Applicationmetadata.json.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/Policy.xml.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/RestrictedDataHelper.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/Program.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/ProcessTaskStartHandler.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/_temp/restricted-data/shared/DataWriteHandler.cs.md" %}}
