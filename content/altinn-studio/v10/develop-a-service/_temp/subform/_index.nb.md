...
{{% insert "altinn-studio/v10/develop-a-service/_temp/subform/studio/_index.nb.md" %}}
{{</content-version-container>}}

{{<content-version-container version-label="Manuelt oppsett">}}
{{% insert "altinn-studio/v10/develop-a-service/_temp/subform/backend-manual/_index.nb.md" %}}
{{</content-version-container>}}
