...
[her](/nb/altinn-studio/v10/develop-a-service/custom-code/integration/maskinporten/).
...
[handlinger](/nb/altinn-studio/v10/develop-a-service/_temp/reference/configuration/authorization/#action-attributter)
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/Applicationmetadata.json.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/Policy.xml.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/RestrictedDataHelper.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/Program.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/ProcessTaskStartHandler.cs.md" %}}
...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/restricted-data/shared/DataWriteHandler.cs.md" %}}
