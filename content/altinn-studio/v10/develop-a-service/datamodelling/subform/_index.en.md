...
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/subform/studio/_index.en.md" %}}
{{</content-version-container>}}

{{<content-version-container version-label="Manuelt oppsett">}}
{{% insert "content/altinn-studio/v10/develop-a-service/datamodelling/subform/backend-manual/_index.en.md" %}}
{{</content-version-container>}}
