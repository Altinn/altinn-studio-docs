...
When running locally using [localtest](/en/altinn-studio/v10/develop-a-service/custom-code/local-dev/), a monitoring stack consisting of Grafana and OpenTelemetry Collector 
