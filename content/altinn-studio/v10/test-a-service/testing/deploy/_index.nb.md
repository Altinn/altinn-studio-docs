...
{{%notice warning%}}
Denne dokumentasjonen blir snart oppdatert. Vi lanserer den nye bygg- og publiseringssiden snart.
{{% /notice%}}

Slik klargjør du appen og distribusjon til testmiljø fra fanen **Publiser** i Altinn Studio.
...
{{%notice info%}}
Bygget bruker filene fra app-repositoriet. Hvis du har gjort endringer på en app i Altinn Studio må du sende disse til repositoriet for at endringene blir med i byggpakken. Du gjør dette ved å velge **Del dine endringer** fra fanen **Utforming** i Altinn Studio.
{{% /notice%}}

Når en app er klar til test kan du bygge den ved å gå til fanen **Publiser** i Altinn Studio (inne på appen du vil distribuere).
...
Når du har bygget en app ferdig kan du distribuere den til testmiljø. Du gjør dette fra fanen **Publiser**. Der ser du en oversikt over tilgjengelige miljøer, i tillegg til en oversikt over hvilke versjoner av appen som finnes i de forskjellige miljøene.
