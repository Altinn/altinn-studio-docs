...
[Template process flow with data and confirmation step](/altinn-studio/v8/reference/configuration/process/Data_Confirmation_Process.bpmn)
...
- [Available process steps in an Altinn app](/altinn-studio/v8/reference/configuration/process/#supported-process-task-types)
- [How to change the process flow of an application](/altinn-studio/v8/reference/configuration/process/#change-the-process)
...
2. Find the relevant rule in the [rule library](/altinn-studio/v8/reference/configuration/authorization/rules/). The rule should cover that a user with the role REGNA or DAGL should be able to confirm the submission of the form (Task2).
3. Add the rule to the policy file. Remember to replace `[RULE_ID]` with the correct ID (follow the pattern of the other rules).

### Useful documentation
- [Rule library](/altinn-studio/v8/reference/configuration/authorization/rules/)
...
1. Create the file `App/logic/Validation/InstanceValidation.cs` (follow the procedure for [custom validation](/altinn-studio/v8/reference/logic/validation/#how-to-add-custom-validation)).
2. Add the validation logic for user ID in the `ValidateTask` class.

### Useful documentation
- [Custom validation](/altinn-studio/v8/reference/logic/validation/#how-to-add-custom-validation)
...
1. Create a text resource that [overrides the default text for the confirmation page](/altinn-studio/v8/reference/configuration/process/customize/#confirmation).

### Useful documentation
- [Customization of the confirmation page](/altinn-studio/v8/reference/configuration/process/customize/#confirmation)
...
* **Copy the content from the [template](/altinn-studio/v8/reference/configuration/process/Data_Confirmation_Process.bpmn) and paste it into the file `App/config/process/process.bpmn`** (replace the entire original content).
...
* **Find the relevant rule in the [rule library](/altinn-studio/v8/reference/configuration/authorization/rules/):**
[User with role REGNA or DAGL can confirm instances of [ORG]/[APP] when it is in Task_2](/altinn-studio/v8/reference/configuration/authorization/rules/#user-with-role-regna-or-dagl-can-confirm-instances-of-orgapp-when-it-is-in-task_2).
...
* **Follow the procedure for [custom validation](/altinn-studio/v8/reference/logic/validation/#how-to-add-custom-validation) to create the file.**
