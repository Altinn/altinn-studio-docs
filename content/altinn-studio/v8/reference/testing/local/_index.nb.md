...
Dersom man skal skrive en del kode (f.eks. [logikk]({{< relref "/altinn-studio/v8/reference/logic" >}})), eller kjapt sjekke hvordan skjema ser ut kan det være nytting å kunne teste endringer uten å måtte deploye hele appen til testmiljø.
...
1. Naviger til app repoet i Altinn Studio. Se [her]({{< relref "/altinn-studio/v8/getting-started/navigation/repos/" >}}) for hvordan man navigerer seg dit.
