...
schemaname: Link # Component schema name used to autogenerate list of properties from json schema (replace with appropriate component name)
...
<p><p><strong>Required properties: </strong><code>id</code>,<code>type</code>,<code>style</code></p><div class="adocs-property-table">
<table>
<tr>
...
<td>The component ID. Must be unique within all layouts/pages in a layout-set. Cannot end with &lt;dash&gt;&lt;number&gt;.<br></td></p>
    ...
    <td><h4><code>openInNewTab</code></h4></td>
    <td>boolean</td>
    <td>Boolean value indicating if the link should be opened in a new tab. Defaults to false.<br></td>
</tr><tr class="main-prop">
    ...
    <td><h4><code>style</code></h4></td>
    <td>string</td>
    <td>The style of the button<br><strong>Enum: </strong>[primary, secondary, link]<br></td>
</tr></table>
    </div>
