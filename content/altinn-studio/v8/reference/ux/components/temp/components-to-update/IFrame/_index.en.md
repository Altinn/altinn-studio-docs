...
schemaname: IFrame # Component schema name used to autogenerate list of properties from json schema (replace with appropriate component name)
...
<p><p><strong>Required properties: </strong><code>id</code>,<code>type</code>,<code>textResourceBindings</code></p><div class="adocs-property-table">
<table>
<tr>
