...
schemaname: List # Komponentens schema-navn, brukes for å automatisk generere liste med egenskaper fra komponentens JSON schema (erstatt med riktig navn i henhold til schema)
...
<p><p><strong>Required properties: </strong><code>id</code>,<code>type</code>,<code>alternatives</code>,<code>default</code></p><div class="adocs-property-table">
<table>
<tr>
...
<td>The component ID. Must be unique within all layouts/pages in a layout-set. Cannot end with &lt;dash&gt;&lt;number&gt;.<br></td></p>
    ...
    <td><h4><code>bindingToShowInSummary</code></h4></td>
    <td>string</td>
    <td>The value of this binding will be shown in the summary component for the list. This binding must be one of the specified bindings under dataModelBindings.<br></td>
</tr><tr class="main-prop">
    <td><h4><code>dataListId</code></h4></td>
    <td>string</td>
    <td>The Id of the list. This id is used to retrive the datalist from the backend.<br></td>
</tr><tr class="main-prop">
    ...
    <td>mapping</td>
    <td>(Optional) Used to map data model paths to query parameters when fetching list data.<br><tr class="main-prop">
    <td><h4><code>mapping</code></h4></td>
    <td>object</td>
    ...
    <td>boolean</td>
    <td>Boolean value indicating if the options should be instance aware. Defaults to false.<br></td>
</tr><tr class="main-prop">
    <td><h4><code>sortableColumns</code></h4></td>
    <td>array</td>
    <td>An array of the columns that is going to be sortable. The column has to be represented by the the headername that is written in tableHeaders.<br></td>
</tr><tr class="main-prop">
    <td><h4><code>tableHeaders</code></h4></td>
    <td>object</td>
    <td>An object where the fields in the datalist is mapped to headers. Must correspond to datalist representing a row. Can be added to the resource files to change between languages.<br><strong>Example(s): </strong><code>{productId: product.id}</code><br></td>
</tr><tr class="main-prop">
    <td><h4><code>tableHeadersMobile</code></h4></td>
    <td>array</td>
    <td>An array of strings representing the columns that is chosen to be shown in the mobile view.<br></td>
</tr></table>
    </div>
