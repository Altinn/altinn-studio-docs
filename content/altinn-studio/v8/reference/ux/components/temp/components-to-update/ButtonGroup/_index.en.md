...
schemaname: ButtonGroup # Component schema name used to autogenerate list of properties from json schema (replace with appropriate component name)
...
<td>The component ID. Must be unique within all layouts/pages in a layout-set. Cannot end with &lt;dash&gt;&lt;number&gt;.<br></td></p>
    ...
    <td>array</td>
    <td>An array of the &#34;id&#34; of child components belonging to the button group.<br></td>
</tr><tr class="main-prop">
