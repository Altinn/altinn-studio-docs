...
A [code list](/en/altinn-studio/v8/guides/development/options) is a predefined list of options.
...
If you wish to [secure dynamic code lists](/en/altinn-studio/v8/guides/development/options/sources/dynamic/#secured-code-lists), you can check this option:
