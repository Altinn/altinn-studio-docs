...
Text can be added directly as a text string or by providing the key to a [text resource].(/altinn-studio/v8/reference/ux/texts/#add-and-change-texts-in-an-application).
