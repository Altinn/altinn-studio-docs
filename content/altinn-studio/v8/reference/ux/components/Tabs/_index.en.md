...
#### `title`
The title of the tab can be added as text directly or referenced via a text key to a [text resource](/en/altinn-studio/v8/reference/ux/texts/#add-and-change-texts-in-an-application).
