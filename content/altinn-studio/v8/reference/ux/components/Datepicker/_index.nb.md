...
| `grid.innerGrid`                       | gridProps | Valgfri. Rammer for indre komponentkontekst, så som input felt dropdown. Brukes for å unngå at feltet fyller komponentens fulle bredde. <br>**Eksempel:** `{xs: 12}` <br>**Se:** [gridProps](/altinn-studio/v8/reference/ux/components/commondefs/#gridProps)                                             |
| `grid.labelGrid`                       | gridProps | Valgfri. Rammer for komponentens tittel. Brukes i kombinasjon med innerGrid for å likestille bredden på titler på siden. <br>**Eksempel:** `{xs: 12}` <br>**Se:** [gridProps](/altinn-studio/v8/reference/ux/components/commondefs/#gridProps)                                                            |
