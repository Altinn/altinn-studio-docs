...
| `grid.innerGrid`                       | gridProps | Optional grid for inner component content like input field or dropdown. Used to avoid inner content filling the component width. <br>**Example(s):** `{xs: 12}` <br>**See:** [gridProps](/altinn-studio/v8/reference/ux/components/commondefs#gridProps)                                               |
| `grid.labelGrid`                       | gridProps | Optional grid for the component label. Used in combination with innerGrid to align labels on the side.<br> **Example(s):** `{xs: 12}`<br> **See:** [gridProps](/altinn-studio/v8/reference/ux/components/commondefs#gridProps)                                                                         |
