...
Get the full name by setting the `dataModelBindings.person_lookup_name` property, or pick specific name parts by using the other name properties.
...
| `dataModelBindings.person_lookup_name`        | string   | Where in the data model the full name should be stored.         (optional)                                         |
| `dataModelBindings.person_lookup_last_name`   | string   | Where in the data model the last name should be stored.         (optional)                                         |
| `dataModelBindings.person_lookup_middle_name` | string   | Where in the data model the middle name should be stored.       (optional)                                         |
| `dataModelBindings.person_lookup_first_name`  | string   | Where in the data model the first name should be stored.        (optional)                                         |
