...
Label for the number. This can be added as a hardcoded string or as a reference to a [text resource](/en/altinn-studio/v8/reference/ux/texts/#add-and-change-texts-in-an-application).
