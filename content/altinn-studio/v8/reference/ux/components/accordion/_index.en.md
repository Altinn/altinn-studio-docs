...
- [`AccordionGroup`](#accordiongroup) - Used to group multiple Accordion components together
...
`AccordionGroup` is used to group related `Accordion` components together.
...
- [`Accordion`](#usage) - Individual accordion component
...
**NB!** To avoid an error message, the `children` property must be added to the component's code.
 See [Add child elements](#add-child-elements-accordiongroup)
{{% /notice %}}
...
### Add child elements {#add-child-elements-accordiongroup}
