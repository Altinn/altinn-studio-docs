...
ligne på noen konfigurasjoner av [Grid-komponenten](/nb/altinn-studio/v8/reference/ux/components/grid/), men tillater brukeren å legge/til
...
for dette. Ved å sette [`edit.mode` til `onlyTable`](/nb/altinn-studio/v8/reference/ux/fields/grouping/repeating/edit#mode) blir alle felter i tabellen redigerbare. Merk at ikke alle komponenter
...
dokumentasjonen for [Grid-komponenten](/nb/altinn-studio/v8/reference/ux/components/grid/).
