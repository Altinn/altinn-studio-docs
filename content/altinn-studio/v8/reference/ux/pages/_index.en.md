...
Layout pages are placed in the `layouts` folder for the layout set; each process task can have its own layout set. To configure the order of the layout pages, see [Navigation](/en/altinn-studio/v8/reference/ux/pages/navigation/#showing-a-side-menu-with-the-order-of-pagestasks). Example of a file structure with two process tasks, each with its own layout set:
...
| showProgress          | Boolean | see [Navigation](/en/altinn-studio/v8/reference/ux/pages/navigation/#showing-a-progress-indicator)                                          |
| pdfLayoutName         | String  | see [PDF](/en/altinn-studio/v8/reference/ux/pdf/#custom-layout-configuration)                                                               |
| order                 | Array   | see [Navigation](/en/altinn-studio/v8/reference/ux/pages/navigation/#showing-a-side-menu-with-the-order-of-pagestasks)                      |
| groups                | Array   | see [Navigation](/en/altinn-studio/v8/reference/ux/pages/navigation/#grouping-pages)                                                        |
| excludeFromPdf        | Array   | see [PDF](/en/altinn-studio/v8/reference/ux/pdf/#automatic-configuration)                                                                   |
