...
are supported by [dynamic expressions](/en/altinn-studio/v8/reference/logic/expressions/)
(read how to [hide entire pages here](/en/altinn-studio/v8/reference/logic/expressions#showhide-entire-pages)).
{{% /panel %}}
