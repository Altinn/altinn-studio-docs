...
To see more possibilities with expressions see [Expressions](../logic/expressions/)
...
The _gatewayAction_ function can be combine with all the other functions in [expressions](../logic/expressions/)
