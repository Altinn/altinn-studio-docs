...
Application logic connected to instantiation can be defined by implementing an interface and registrering them in `Program.cs`
 ...
 - `IInstantiationProcessor` - create customized prefill data, this is described in the [prefill chapter]({{< relref "/altinn-studio/v8/guides/development/prefill/custom/" >}}).
