...
av [dynamiske uttrykk](/nb/altinn-studio/v8/reference/logic/expressions/).
{{% /panel %}}

![Logikkmeny](ui-editor-logic-menu.png?height=300px "Logikkmeny")

For backend så håndteres logikk gjennom forskjellige grensesnitt. Disse er beskrevet på de forskjellige sidene under dette området som f. eks. [data prosessering](/nb/altinn-studio/v8/reference/logic/dataprocessing/).
