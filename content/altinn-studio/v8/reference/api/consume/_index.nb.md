...
For å berike skjemadata må vi koble klienten vår til logikken i _App/logic/DataProcessingHandler.cs_ i metoden _ProcessDataWrite_. Merk at for v7 av applikasjonsmalen er dette endret, se [dataprossessering](/nb/altinn-studio/v8/reference/logic/dataprocessing/).
