...
Data fields are in many ways similar to [presentation fields]({{< relref "/altinn-studio/v8/reference/configuration/messagebox/presentationfields/" >}}). But where the use of presentation fields is predefined, the use of data fields is completely up to the individual application owner.
