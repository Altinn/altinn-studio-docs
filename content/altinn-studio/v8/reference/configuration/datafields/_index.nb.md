...
Datafelter er på mange måter tilsvarende [presentasjonsfelter]({{< relref "/altinn-studio/v8/reference/configuration/messagebox/presentationfields/" >}}). Men der hvor bruken av presentasjonsfelter er forhåndsbestemt (benyttes i meldingsboksen til Altinn), er bruken av datafelter opp til den enkelte applikasjonseier.
