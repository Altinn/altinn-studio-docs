...
Per i dag blir ikke verdier fra KeyVault lest inn i konfigurasjonsstyringen av en App. Isteden må man benytte Secrets komponenten. Dette er dokumentert under [hemmeligheter]({{< relref "/altinn-studio/v8/reference/configuration/secrets" >}}).
