...
The front-end of Altinn Studio designer is set up using the same React + Redux architecture as the App frontend, take a look [here](/app-template/architecture/app-frontend/react) 
for more details.
