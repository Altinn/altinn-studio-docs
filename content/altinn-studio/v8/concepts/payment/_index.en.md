...
Support for using Nets Easy as a payment provider comes with the application. Guidance on setting up Nets Easy can be found [here]({{< relref "/altinn-studio/v8/guides/development/payment" >}}).
