...
See documentation here: https://docs.altinn.studio/en/altinn-studio/v8/guides/design/guidelines/components/
### Text components
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/title-and-paragraph/">Title</a><br>("Header" in json)</td>
      <td>
        <ul>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/title-and-paragraph/">Paragraph</a></td>
      <td>
        <ul>
...
<table>
  <tbody>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/input/">Input</a></td>
      <td>
        <ul>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/checkbox/">Checkboxes</a></td>
      <td>
        <ul>
          <li>Link to data model</li>
          <li>Label text</li>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/radiobutton/">Radio buttons</a></td>
      <td>
        <ul>
          <li>Link to data model</li>
          <li>Label text</li>
      ...
      <td>
        ...
        <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/dropdown/">Dropdown</a></td>
      <td>
        <ul>
          <li>Link to data model</li>
          <li>Label text</li>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/date/">Datepicker</a></td>
      <td>
        <ul>
          <li>Link to data model</li>
          <li>Label text</li>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/button/">Button</a></td>
      <td>
        <ul>
    ...
    <tr>
      <td><a href="/en/altinn-studio/v8/guides/design/guidelines/components/file-upload/">File Upload</a></td>
      <td>
        <ul>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img alt="Address (advanced mode) - default look" src="display-address-advanced.png?width=700" title="Address (advanced mode) - default look" /></td>
        ...
        <tr>
      <td><a href="/en/altinn-studio/v8/reference/ux/fields/grouping/">Group</a> <br/></td>
      <td>
        <ul>
          <li>Group id</li>
