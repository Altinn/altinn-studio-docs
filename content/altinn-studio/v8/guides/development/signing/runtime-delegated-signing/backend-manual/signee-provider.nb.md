...
Når en organisasjon er oppgitt som signatar så vil de som har en [nøkkelrolle]({{< relref "/altinn-studio/v8/reference/configuration/authorization/guidelines_authorization/roles_and_rights/roles_er/#nøkkelroller" >}}) i organisasjonen få `read` og `sign` rettigheter til instansen.
