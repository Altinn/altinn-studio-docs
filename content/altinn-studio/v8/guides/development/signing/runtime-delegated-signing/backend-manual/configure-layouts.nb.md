...
- SigningActions: 
  - Utleder status for signeringssteget og viser relevante knapper til sluttbruker, f.eks. "Signer"-knappen. Les mer [her](/nb/altinn-studio/v8/reference/ux/components/signingactions/).
