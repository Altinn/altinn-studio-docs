...
1. Ved å bruke [dynamikk](/nb/altinn-studio/v8/guides/development/dynamics/) for å skjule og vise helt forskjellige komponenter basert på en betingelse. Disse
   komponentene kan være bundet til samme sted i datamodellen, men ha forskjellige svaralternativer. Merk at
   [automatisk opprydding](/nb/altinn-studio/v8/guides/development/options/functionality/automatic-cleanup/) kan fjerne verdier fra datamodellen når du bruker denne metoden.
2. Ved å bruke [dynamiske alternativer](/nb/altinn-studio/v8/guides/development/options/sources/dynamic/) og sende spørringsparametre til backenden, kan du skrive 
...
3. Ved å bruke [svaralternativer fra en repeterende struktur i datamodellen](/nb/altinn-studio/v8/guides/development/options/sources/from-data-model/). I kombinasjon
...
[statiske svaralternativer](/nb/altinn-studio/v8/guides/development/options/sources/static/).
Dette gjør det mulig å bruke et [dynamisk uttrykk](/nb/altinn-studio/v8/guides/development/dynamics/) for å filtrere ut svaralternativer basert
...
Hvis du bruker [kodelister fra en repeterende struktur i datamodellen](/nb/altinn-studio/v8/guides/development/options/sources/from-data-model/), vil uttrykket
...
av [dynamikk i `hiddenRow`-egenskapen](/nb/altinn-studio/v8/reference/ux/fields/grouping/repeating/dynamics/), selv om et
...
1. De allerede brukte ingredienstypene lagres i en kommaseparert liste i feltet `UsedTypes` i datamodellen. Dette feltet
   oppdateres ved hjelp av [dataprosessering](/nb/altinn-studio/v8/reference/logic/dataprocessing/) som finner alle unike
...
2. Hvis vi bare sjekket `UsedTypes`-feltet mot `value`-verdien til den nåværende `Dropdown`-komponenten, ville alternativet
   ...
   ville da [blitt automatisk ryddet opp](/nb/altinn-studio/v8/guides/development/options/functionality/automatic-cleanup/). Av denne grunn sjekker vi også at `value` ikke er lik
...
også [implementere validering](/nb/altinn-studio/v8/reference/logic/validation/) for å fange opp eventuelle duplikate verdier.
{{% /notice %}}
