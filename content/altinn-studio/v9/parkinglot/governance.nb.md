...
## App-biblioteker
App-bibliotekene består av [Altinn.App.Api, Altinn.App.Core](https://github.com/Altinn/altinn-studio/tree/main/src/App/backend) og [frontend](https://github.com/Altinn/altinn-studio/tree/main/src/App/frontend).

- Backend-bibliotekene ligger på NuGet.org. Alle Studio-apper refererer til disse bibliotekene
...
- Utvikling og arbeid organiseres [i Altinn/altinn-studio GitHub-repoet](https://github.com/Altinn/altinn-studio).

## Localtest
[Localtest](https://github.com/Altinn/altinn-studio/tree/main/src/Runtime/localtest) er en lokal kopi av kjerne-API-ene i Altinn-plattformen.
