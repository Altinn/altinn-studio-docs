...
Du kan kopiere regelen fra [regelbiblioteket]({{< relref "/altinn-studio/v9/develop-a-service/reference/configuration/authorization/rules#org-kan-slette-en-instans-av-orgapp-uavhengig-av-hvor-den-er-i-prosessen" >}}).
