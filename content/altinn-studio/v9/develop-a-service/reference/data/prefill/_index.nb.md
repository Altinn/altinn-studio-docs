...
---
Les mer om [forhåndsutfylling](/nb/altinn-studio/v9/this-is-AS/explanations/prefill/), og se [veiledning for hvordan du setter det opp](/nb/altinn-studio/v9/develop-a-service/data/prefill/how-to/config/).
...
Forhåndsutfyllingen feiler hvis objektet du bruker ikke finnes. Hvis du vil forhåndsutfylle dynamisk basert på disse verdiene, må du sette opp [egendefinert forhåndsutfylling](/nb/altinn-studio/v9/develop-a-service/data/prefill/how-to/custom/).
