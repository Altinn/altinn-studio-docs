...
Add a [text resource file](/en/altinn-studio/v9/reference/ux/texts/) under 'App/config/texts' for each language you want to support.
...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/backend-manual/setup-text-resources-code-01.en.md" %}}
