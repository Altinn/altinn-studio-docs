...
- SigneeList:
  - Lists the signees and their signing status. Read more [here](/en/altinn-studio/v9/reference/ux/components/signeelist/).
- SigningDocumentList:
  - Lists the data being signed. For example attachments, xml-data or a PDF summary from an earlier step. Read more [here](/en/altinn-studio/v9/reference/ux/components/signingdocumentlist/).
- SigningActions: 
  - Determines the current status of the signing task and present relevant information and buttons to the end user, for instance the "Sign"-button. Read more [here](/en/altinn-studio/v9/reference/ux/components/signingactions/).
