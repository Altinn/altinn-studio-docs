...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/backend-manual/add-process-task-environments.en.md" %}}
...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/backend-manual/add-process-task-code-01.en.md" %}}

This data type is used to store information about the signers and their status.

{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/backend-manual/add-process-task-code-02.en.md" %}}
...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/backend-manual/add-process-task-code-03.en.md" %}}
