...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/api-signing/intro.en.md" %}}
...
You can see how to configure signing in an app using the guides found [here](/en/altinn-studio/v9/develop-a-service/process/signing/).
...
If [runtime-delegated signing](/en/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/) is configured, the following endpoint can be used to get a list of the signees and their signing status.
