...
Hvis [brukerstyrt signering](/nb/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/) er satt opp, kan du bruke følgende API-endepunkt for å hente ut en liste med de som skal signere (signatarer) og deres signeringsstatus.
