...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/role-based-signing/intro.en.md" %}}

## Prerequisites

### Maskinporten
Maskinporten is required if you wish to use the [message service](#correspondence) and/or place [access restrictions](/en/altinn-studio/v9/develop-a-service/data/restricted-data/) on the signature objects.
...
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/role-based-signing/backend-manual/add-process-task.en.md" %}}
{{</content-version-container>}}

{{<content-version-container version-label="Altinn Studio Designer">}}
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/role-based-signing/studio/add-process-task.en.md" %}}
{{</content-version-container>}}
...
{{<content-version-container version-label="Altinn Studio Designer">}}
{{% insert "content/altinn-studio/v9/develop-a-service/process/signing/how-to/role-based-signing/studio/configure-layouts.nb.md" %}}
{{</content-version-container>}}
