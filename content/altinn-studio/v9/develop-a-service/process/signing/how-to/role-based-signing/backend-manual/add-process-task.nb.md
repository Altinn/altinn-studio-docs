...
Hvis du har valgt å sende signeringskvitteringer ved å spesifisere en correspondence-ressurs, [les om hvordan du konfigurerer miljøspesifikke correspondence-ressurser](/nb/altinn-studio/v9/develop-a-service/process/signing/how-to/runtime-delegated-signing/#konfigurere-miljø-spesifikke-correspondence-ressurser).
