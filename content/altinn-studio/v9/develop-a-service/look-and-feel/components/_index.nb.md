...
`OrganizationLookup`-komponenten bruker organisasjonsnummer til å slå opp en organisasjon i Enhetsregisteret.
...
[stateless-oppsettet.]({{<relref "/altinn-studio/v9/develop-a-service/process/stateless">}})
