...
|----------|-------------|----------------|
| `data` | Required. |  |
| `data.dataType` | The name of the datamodel type to reference Required. |  |
| `data.field` | The path to the property using dot-notation Required. |  |
