...
Når appen kjører kan du teste den på [http://local.altinn.cloud:8000](http://local.altinn.cloud:8000) med en [testbruker](/nb/altinn-studio/v9/test-a-service/testing/local/testusers/).
