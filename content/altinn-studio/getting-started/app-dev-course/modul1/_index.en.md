...
{{% notice info %}}
If you want to test the app in a [test environment](/altinn-studio/reference/testing/deploy/) (described in [Module 3](/altinn-studio/getting-started/app-dev-course/modul3/)), you need to select an organization as the owner.
